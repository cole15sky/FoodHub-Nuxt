        ...
        <div class="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
            ...
            <div class="flex md:order-2 items-center">
                ...
                <NuxtLink to="/orders">
                    ...
                    <div class="relative">
                        <NuxtLink to="/orders">
                            <svg width="64px" height="64px" viewBox="-276.48 -276.48 1576.96 1576.96" class="icon ms-4"
                                version="1.1" xmlns="http://www.w3.org/2000/svg" fill="#000000"
                                transform="matrix(1, 0, 0, 1, 0, 0)rotate(0)" stroke="#000000" stroke-width="9.216">
                                    <g id="SVGRepo_bgCarrier" stroke-width="0">
                                        <rect x="-276.48" y="-276.48" width="1576.96" height="1576.96" rx="788.48"
                                            fill="#ced7da" strokewidth="0"></rect>
                                    </g>
...
const orderStore = useOrderStore(); // Access the Pinia store
</script>